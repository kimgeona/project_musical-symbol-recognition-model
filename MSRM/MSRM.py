...
def draw_boxes_on_image(
    ...
    class_colors = {
        ...
        1: (211, 211, 211),     # 클래스  1: 회색 -> clef
        2: (255, 0, 255),       # 클래스  2: 마젠타 -> key
        3: (255, 255, 0),       # 클래스  3: 아쿠아 -> measure
        4: (0, 0, 255),         # 클래스  4: 빨간색 -> rest
        5: (128, 128, 0),       # 클래스  5: 틸 -> time
        6: (255, 0, 0),         # 클래스  6: 파란색 -> note
        7: (75, 0, 130),        # 클래스  7: 와인 -> accidental
        8: (147, 20, 255),      # 클래스  8: 진분홍 -> articulation
        9: (208, 224, 64),      # 클래스  9: 터키옥색 -> dynamic
        10: (255, 69, 0),       # 클래스 10: 오렌지색 -> glissando
        11: (63, 133, 255),     # 클래스 11: 페루 -> octave
        12: (130, 0, 75),       # 클래스 12: 인디고 -> ornament
        13: (113, 179, 60),     # 클래스 13: 중간바다초록 -> repetition
        14: (0, 252515, 255),   # 클래스 14: 노란색 -> tie
